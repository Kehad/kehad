...
const Project = function (props) {
  ...
  return (
    <div className={classes.project}>
      <h1 className={classes["project__greeting"]}>Project</h1>
        {
            /*
                <svg
      ...
      {/* <Pagination /> */}
      {/* <Pagination arrow={arrowLeft} /> */}
      <ProjectList />
      {/* <Pagination arrow={arrowRight}  /> */}
